...
Sys.Mvc.NumberValidator.create = function Sys_Mvc_NumberValidator$create(rule) {
    /// <param MemberName="rule" type="Sys.Mvc.JsonValidationRule">
    /// </param>
...
Sys.Mvc.NumberValidator.prototype = {
    ...
    validate: function Sys_Mvc_NumberValidator$validate(value, context) {
        ...
        /// </param>
        /// <param MemberName="context" type="Sys.Mvc.ValidationContext">
        /// </param>
...
Sys.Mvc.FormContext = function Sys_Mvc_FormContext(formElement, validationSummaryElement) {
    /// <param MemberName="formElement" type="Object" domElement="true">
    /// </param>
    /// <param MemberName="validationSummaryElement" type="Object" domElement="true">
    /// </param>
    /// <field MemberName="_validationSummaryErrorCss" type="String" static="true">
    /// </field>
    /// <field MemberName="_validationSummaryValidCss" type="String" static="true">
    /// </field>
    /// <field MemberName="_formValidationTag" type="String" static="true">
    /// </field>
    /// <field MemberName="_onClickHandler" type="Sys.UI.DomEventHandler">
    /// </field>
    /// <field MemberName="_onSubmitHandler" type="Sys.UI.DomEventHandler">
    /// </field>
    /// <field MemberName="_errors" type="Array">
    /// </field>
    /// <field MemberName="_submitButtonClicked" type="Object" domElement="true">
    /// </field>
    /// <field MemberName="_validationSummaryElement" type="Object" domElement="true">
    /// </field>
    /// <field MemberName="_validationSummaryULElement" type="Object" domElement="true">
    /// </field>
    /// <field MemberName="fields" type="Array" elementType="FieldContext">
    /// </field>
    /// <field MemberName="_formElement" type="Object" domElement="true">
    /// </field>
    /// <field MemberName="replaceValidationSummary" type="Boolean">
    /// </field>
    this._errors = [];
...
Sys.Mvc.FormContext._isElementInHierarchy = function Sys_Mvc_FormContext$_isElementInHierarchy(parent, child) {
    /// <param MemberName="parent" type="Object" domElement="true">
    /// </param>
    /// <param MemberName="child" type="Object" domElement="true">
    /// </param>
...
Sys.Mvc.FormContext._parseJsonOptions = function Sys_Mvc_FormContext$_parseJsonOptions(options) {
    /// <param MemberName="options" type="Sys.Mvc.JsonValidationOptions">
    /// </param>
    /// <returns type="Sys.Mvc.FormContext"></returns>
...
Sys.Mvc.FormContext.prototype = {
    ...
    addError: function Sys_Mvc_FormContext$addError(message) {
        /// <param MemberName="message" type="String">
        /// </param>
        this.addErrors([ message ]);
    },
    
    addErrors: function Sys_Mvc_FormContext$addErrors(messages) {
        /// <param MemberName="messages" type="Array" elementType="String">
        /// </param>
    ...
    _findSubmitButton: function Sys_Mvc_FormContext$_findSubmitButton(element) {
        /// <param MemberName="element" type="Object" domElement="true">
        /// </param>
    ...
    _form_OnClick: function Sys_Mvc_FormContext$_form_OnClick(e) {
        /// <param MemberName="e" type="Sys.UI.DomEvent">
        /// </param>
    ...
    validate: function Sys_Mvc_FormContext$validate(eventName) {
        /// <param MemberName="eventName" type="String">
        /// </param>
...
Sys.Mvc.FieldContext = function Sys_Mvc_FieldContext(formContext) {
    /// <param MemberName="formContext" type="Sys.Mvc.FormContext">
    /// </param>
    /// <field MemberName="_hasTextChangedTag" type="String" static="true">
    /// </field>
    /// <field MemberName="_hasValidationFiredTag" type="String" static="true">
    /// </field>
    /// <field MemberName="_inputElementErrorCss" type="String" static="true">
    /// </field>
    /// <field MemberName="_inputElementValidCss" type="String" static="true">
    /// </field>
    /// <field MemberName="_validationMessageErrorCss" type="String" static="true">
    /// </field>
    /// <field MemberName="_validationMessageValidCss" type="String" static="true">
    /// </field>
    /// <field MemberName="_onBlurHandler" type="Sys.UI.DomEventHandler">
    /// </field>
    /// <field MemberName="_onChangeHandler" type="Sys.UI.DomEventHandler">
    /// </field>
    /// <field MemberName="_onInputHandler" type="Sys.UI.DomEventHandler">
    /// </field>
    /// <field MemberName="_onPropertyChangeHandler" type="Sys.UI.DomEventHandler">
    /// </field>
    /// <field MemberName="_errors" type="Array">
    /// </field>
    /// <field MemberName="defaultErrorMessage" type="String">
    /// </field>
    /// <field MemberName="elements" type="Array" elementType="Object" elementDomElement="true">
    /// </field>
    /// <field MemberName="formContext" type="Sys.Mvc.FormContext">
    /// </field>
    /// <field MemberName="replaceValidationMessageContents" type="Boolean">
    /// </field>
    /// <field MemberName="validationMessageElement" type="Object" domElement="true">
    /// </field>
    /// <field MemberName="validations" type="Array" elementType="Validation">
    /// </field>
    this._errors = [];
...
Sys.Mvc.FieldContext.prototype = {
    ...
    _getErrorString: function Sys_Mvc_FieldContext$_getErrorString(validatorReturnValue, fieldErrorMessage) {
        /// <param MemberName="validatorReturnValue" type="Object">
        /// </param>
        /// <param MemberName="fieldErrorMessage" type="String">
        /// </param>
...
Sys.Mvc.RangeValidator = function Sys_Mvc_RangeValidator(minimum, maximum) {
    /// <param MemberName="minimum" type="Number">
    /// </param>
    /// <param MemberName="maximum" type="Number">
    /// </param>
    /// <field MemberName="_minimum" type="Number">
    /// </field>
    /// <field MemberName="_maximum" type="Number">
    /// </field>
...
Sys.Mvc.RangeValidator.prototype = {
    ...
    validate: function Sys_Mvc_RangeValidator$validate(value, context) {
        /// <param MemberName="value" type="String">
        /// </param>
        /// <param MemberName="context" type="Sys.Mvc.ValidationContext">
        /// </param>
        /// <returns type="Object"></returns>
...
Sys.Mvc.RegularExpressionValidator = function Sys_Mvc_RegularExpressionValidator(pattern) {
    /// <param MemberName="pattern" type="String">
    /// </param>
    /// <field MemberName="_pattern" type="String">
    /// </field>
...
Sys.Mvc.RequiredValidator._validateRadioInput = function Sys_Mvc_RequiredValidator$_validateRadioInput(elements) {
    /// <param MemberName="elements" type="Array" elementType="Object" elementDomElement="true">
    /// </param>
    /// <returns type="Object"></returns>
    for (var i = 0; i < elements.length; i++) {
        var element = elements[i];
...
Sys.Mvc.RequiredValidator._validateSelectInput = function Sys_Mvc_RequiredValidator$_validateSelectInput(optionElements) {
    /// <param MemberName="optionElements" type="DOMElementCollection">
    /// </param>
    /// <returns type="Object"></returns>
...
Sys.Mvc.StringLengthValidator = function Sys_Mvc_StringLengthValidator(minLength, maxLength) {
    /// <param MemberName="minLength" type="Number" integer="true">
    /// </param>
    /// <param MemberName="maxLength" type="Number" integer="true">
    /// </param>
    /// <field MemberName="_maxLength" type="Number" integer="true">
    /// </field>
    /// <field MemberName="_minLength" type="Number" integer="true">
    /// </field>
...
Sys.Mvc._validationUtil.arrayIsNullOrEmpty = function Sys_Mvc__validationUtil$arrayIsNullOrEmpty(array) {
    /// <param MemberName="array" type="Array" elementType="Object">
    /// </param>
    /// <returns type="Boolean"></returns>
...
Sys.Mvc._validationUtil.elementSupportsEvent = function Sys_Mvc__validationUtil$elementSupportsEvent(element, eventAttributeName) {
    /// <param MemberName="element" type="Object" domElement="true">
    /// </param>
    /// <param MemberName="eventAttributeName" type="String">
    /// </param>
    /// <returns type="Boolean"></returns>
...
Sys.Mvc._validationUtil.setInnerText = function Sys_Mvc__validationUtil$setInnerText(element, innerText) {
    /// <param MemberName="element" type="Object" domElement="true">
    /// </param>
    /// <param MemberName="innerText" type="String">
    /// </param>
...
Sys.Mvc.ValidatorRegistry = function Sys_Mvc_ValidatorRegistry() {
    /// <field MemberName="validators" type="Object" static="true">
    /// </field>
}
