...
Type._registerNamespace = function Type$_registerNamespace(namespacePath) {
    if (!Type.__fullyQualifiedIdentifierRegExp.test(namespacePath)) throw Error.argument('MemberNamespacePath', Sys.Res.invalidNameSpace);
    ...
    for (var i = 0; i < namespaceParts.length; i++) {
        ...
        if (!ns.__namespace) {
            ...
            if (parsedName !== ns) {
                ...
                throw Error.argument('MemberNamespacePath', Sys.Res.invalidNameSpace);
            }
...
Sys._Debug = function Sys$_Debug() {
    ...
    function Sys$_Debug$traceDump(object, name) {
        ...
        var e = Function._validateParams(arguments, [
            {name: "object", mayBeNull: true},
            {name: "MemberName", type: String, mayBeNull: true, optional: true}
        ]);
        if (e) throw e;
...
Type.prototype.registerEnum = function Type$registerEnum(name, flags) {
    ...
    if (e) throw e;
    if (!Type.__fullyQualifiedIdentifierRegExp.test(name)) throw Error.argument('MemberName', Sys.Res.notATypeName);
    var parsedName;
    try {
        parsedName = eval(name);
    }
    catch(e) {
        throw Error.argument('MemberName', Sys.Res.argumentTypeName);
    }
    if (parsedName !== this) throw Error.argument('MemberName', Sys.Res.badTypeName);
...
var $create = Sys.Component.create = function Sys$Component$create(type, properties, events, references, element) {
    ...
    /// <param MemberName="references" optional="true" mayBeNull="true"></param>
...
var $addHandler = Sys.UI.DomEvent.addHandler = function Sys$UI$DomEvent$addHandler(element, eventName, handler, autoRemove) {
    ...
    /// <param MemberName="eventName" type="String"></param>
    /// <param MemberName="handler" type="Function"></param>
    /// <param MemberName="autoRemove" type="Boolean" optional="true"></param>
    var e = Function._validateParams(arguments, [
        {name: "element"},
        {name: "eventName", type: String},
        {name: "handler", type: Function},
...
Sys.Net.WebServiceProxy = function Sys$Net$WebServiceProxy() {
    ...
    function Sys$Net$WebServiceProxy$_invoke(servicePath, methodName, useGet, params, onSuccess, onFailure, userContext) {
        ...
        /// <param MemberName="params"></param>
        /// <param MemberName="onSuccess" type="Function" mayBeNull="true" optional="true"></param>
        /// <param MemberName="onFailure" type="Function" mayBeNull="true" optional="true"></param>
        /// <param MemberName="userContext" mayBeNull="true" optional="true"></param>
...
Sys.Net.WebServiceProxy.invoke = function Sys$Net$WebServiceProxy$invoke(servicePath, methodName, useGet, params, onSuccess, onFailure, userContext, timeout, enableJsonp, jsonpCallbackParameter) {
    ...
    /// <param MemberName="params" mayBeNull="true" optional="true"></param>
    /// <param MemberName="onSuccess" type="Function" mayBeNull="true" optional="true"></param>
    /// <param MemberName="onFailure" type="Function" mayBeNull="true" optional="true"></param>
    /// <param MemberName="userContext" mayBeNull="true" optional="true"></param>
    /// <param MemberName="timeout" type="Number" optional="true"></param>
    /// <param MemberName="enableJsonp" type="Boolean" optional="true" mayBeNull="true"></param>
    /// <param MemberName="jsonpCallbackParameter" type="String" optional="true" mayBeNull="true"></param>
    /// <returns type="Sys.Net.WebRequest" mayBeNull="true"></returns>
    var e = Function._validateParams(arguments, [
        {name: "servicePath", type: String},
...
Sys.Net.WebServiceError = function Sys$Net$WebServiceError(timedOut, message, stackTrace, exceptionType, errorObject) {
    ...
    /// <param MemberName="exceptionType" type="String" mayBeNull="true" optional="true"></param>
    /// <param MemberName="errorObject" type="Object" mayBeNull="true" optional="true"></param>
    var e = Function._validateParams(arguments, [
...
'observableConflict':'Object already contains a member with the MemberName \'{0}\'.',
