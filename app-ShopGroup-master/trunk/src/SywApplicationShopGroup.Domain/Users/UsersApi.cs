...
namespace SywApplicationShopGroup.Domain.Users
{
	public interface IUsersApi
	{
	    ...
	    IList<UserDto> GetFollowers(long userId);
	}
	...
	public class UsersApi : ApiBase, IUsersApi
	{
        ...
        public IList<UserDto> GetFollowers(long userId)
        {
            var ids = Call<IList<long>>("followers", new { UserId = userId });
            return !ids.Any() ?
                new UserDto[0] :
                Get(ids);
        }
